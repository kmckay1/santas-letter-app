...
function hollySvg(flipX: boolean): string {
  ...
  return (
    '<svg width="80" height="52" viewBox="0 0 80 52" xmlns="http://www.w3.org/2000/svg">' +
      '<defs>' +
        '<radialGradient id="b1' + (flipX ? 'r' : 'l') + '" cx="40%" cy="35%"><stop offset="0%" stop-color="#e05555"/><stop offset="100%" stop-color="#6b0f0f"/></radialGradient>' +
        '<radialGradient id="b2' + (flipX ? 'r' : 'l') + '" cx="40%" cy="35%"><stop offset="0%" stop-color="#e05555"/><stop offset="100%" stop-color="#6b0f0f"/></radialGradient>' +
        '<radialGradient id="b3' + (flipX ? 'r' : 'l') + '" cx="40%" cy="35%"><stop offset="0%" stop-color="#e87070"/><stop offset="100%" stop-color="#8b1a1a"/></radialGradient>' +
      '</defs>' +
      '<g transform="' + transform + '">' +
        ...
        '<circle cx="58" cy="22" r="7" fill="url(#b1' + (flipX ? 'r' : 'l') + ')"/>' +
        '<circle cx="54" cy="9" r="6" fill="url(#b2' + (flipX ? 'r' : 'l') + ')"/>' +
        '<circle cx="66" cy="14" r="6.5" fill="url(#b3' + (flipX ? 'r' : 'l') + ')"/>' +
